...
function StoryCanvas({ children }: { children: ReactNode }) {
  ...
  return (
    <LevaStoreProvider store={store}>
      ...
      <div className="flex min-h-dvh justify-center bg-[#070504]">
        <div className="relative flex w-full max-w-[400px] flex-col overflow-hidden border-x border-[#3a2c17] bg-[radial-gradient(120%_80%_at_50%_-10%,rgba(201,162,74,.16),transparent_60%),linear-gradient(180deg,var(--color-chamber-from),var(--color-chamber-to))] font-body text-parchment">
